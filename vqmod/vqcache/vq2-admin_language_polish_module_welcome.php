 ...
 * @version     1.5.1.1 $Id: text.php 3 2011-08-29 11:09:52Z krzysztof.kardasz $
 * @link        http://opencart-polish.googlecode.com
 * @link        http://opencart-polish.googlecode.com/svn/branches/1.5.x/
 */
// Heading
global $os; $_['heading_title']=$os['text_modules'];//       = 'Powitanie';

// Text
$_['text_module']         = 'Moduły';
$_['text_success']        = 'Sukces: Zmiany modułu powitania zostały zapisane!';
...
// Entry
$_['entry_description']   = 'Wiadomość powitalna:';
...
// Error
$_['error_permission']    = 'Uwaga: Nie masz uprawnień do modyfikacji modułu powitania!';
?>