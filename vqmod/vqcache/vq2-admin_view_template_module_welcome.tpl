    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          <div <?php if (count($languages) == 1) echo 'hidden="true" '; ?>id="language-<?php echo $module_row; ?>" class="htabs">
...
function addModule() {	
	...
	html += '  <div <?php if (count($languages) == 1) echo 'hidden="true" '; ?>id="language-' + module_row + '" class="htabs">';
    <?php foreach ($languages as $language) { ?>
