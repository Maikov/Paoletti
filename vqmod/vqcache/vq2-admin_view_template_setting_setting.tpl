...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-store"><?php echo $theming_design; ?></a><a href="#tab-local"><?php echo $tab_local; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            <tr>
              <td><span class="required">*</span> <?php echo $entry_name; ?></td>
              <td><input type="text" name="config_name" onchange="document.getElementsByName('config_title')[0].value=this.value;" value="<?php echo $config_name; ?>" size="40" />
                <?php if ($error_name) { ?>
...
<tr>
            ...
            <tr>
<!--MXS-->
                  <td><?php echo $theming_animate; ?></td>
                  <td><input type="radio" name="theme_animate" value="1" <?php if ($theme_animate) echo 'checked="checked"'; ?> />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="theme_animate" value="0" <?php if (!$theme_animate) echo 'checked="checked"'; ?> />
                      <?php echo $text_no; ?>
                  </td>
              </tr>
              <tr>
                  <td><?php echo $theming_animate_pages; ?></td>
                  <td><input type="radio" name="theme_animate_pages" value="1" <?php if ($theme_animate_pages==1) echo 'checked="checked"'; ?> />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="theme_animate_pages" value="0" <?php if (!$theme_animate_pages) echo 'checked="checked"'; ?> />
                      <?php echo $text_no; ?>
                      <input type="radio" name="theme_animate_pages" value="2" <?php if ($theme_animate_pages==2) echo 'checked="checked"'; ?> />
                      <?php echo $theming_homepage_only; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><?php echo $theming_background; ?></td>
                <td><div class="image"><img src="<?php echo $back; ?>" alt="" id="thumb-back" />
                  <input type="hidden" name="theme_background" value="<?php echo $theme_background; ?>" id="back" />
                  <br />
                  <a onclick="image_upload('back', 'thumb-back');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-back').attr('src', '<?php echo $no_image; ?>'); $('#back').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
              </tr>
            <!--MXE-->
            <tr>
...
<!--MX start--><div style="display:none;">
