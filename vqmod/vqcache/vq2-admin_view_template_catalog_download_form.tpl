<?php echo $header; ?>
<script src="view/javascript/mxUpload.js"></script>
<div id="content">
        ...
        <table class="form">
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="text" id="desc" name="download_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($download_description[$language['language_id']]) ? $download_description[$language['language_id']]['name'] : ''; ?>" />
