...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-seo"><?php if (!isset($tab_seo)) $tab_seo='SEO'; echo $tab_seo; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <div <?php if (count($languages) == 1) echo 'hidden="true" '; ?>id="languages" class="htabs">
...
<div id="tab-seo">
            ...
            <div <?php if (count($languages) == 1) echo 'hidden="true" '; ?>id="languages1" class="htabs">
                <?php foreach ($languages as $language) { ?>
            ...
            <?php foreach ($languages as $language) { ?>
            <div <?php if (count($languages) == 1) echo 'hidden="true" '; ?>id="language-1<?php echo $language['language_id']; ?>">
                <table class="form">
