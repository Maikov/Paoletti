...
class ModelCatalogRecord extends Model
{
	...
	public function getRecord($record_id)
	{
		...
		(SELECT price FROM " . DB_PREFIX . "record_discount pd2
		WHERE
		pd2.record_id = p.record_id
		AND
		pd2.customer_group_id = '" . (int) $customer_group_id . "'
		AND
		pd2.quantity = '1'
		AND
		...
		ORDER BY
		pd2.priority ASC, pd2.price ASC LIMIT 1) AS discount,
