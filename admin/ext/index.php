...
// ------- Check if we are running from /admin area of OpenCart
if (file_exists('../../system/startup.php')) {
// ------- OpenCart integration code ------
//MXS
...
// Request - bugs file saving rotine, commented out
//$request = new Request();
...
// Check rights
if (!@$user->hasPermission('modify', 'user/user_permission')) {

echo "Unsufficient permissions to use server file manager!";
exit;
