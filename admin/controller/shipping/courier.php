...
class ControllerShippingcourier extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['courier_rate'])) {
			$this->data['courier_rate'] = $this->request->post['courier_rate'];
		} elseif ($this->config->get('courier_rate')) {
			$this->data['courier_rate'] = $this->config->get('courier_rate');
		} else {
			$this->data['courier_rate'] = '10:11.6,15:14.1,20:16.60,25:19.1,30:21.6,35:24.1,40:26.6,45:29.1,50:31.6,55:34.1,60:36.6,65:39.1,70:41.6,75:44.1,80:46.6,100:56.6,125:69.1,150:81.6,200:106.6';	
		}
