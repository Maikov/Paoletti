...
class ControllerModuleNews extends Controller {
	...
	private function getModule() {
		...
		$this->data['text_content_top_logo'] = $this->language->get('text_content_top_logo');
        ...
        if (!$this->data['news_headline_chars']) $this->data['news_headline_chars']='200';
        ...
        if (!$this->data['news_thumb_width']) $this->data['news_thumb_width']='96';
        ...
        if (!$this->data['news_thumb_height']) $this->data['news_thumb_height']='96';
	...
	private function getList() {
		...
		$this->data['button_insert'] = $this->language->get('text_add');
		$this->data['button_delete'] = $this->language->get('text_delete');
        $this->data['button_mail'] = $this->language->get('text_mail');
