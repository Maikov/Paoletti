...
$_['heading_title']        = 'Модификации (vQMod)';
...
$_['column_file_name']     = 'Модификация';
...
$_['entry_upload']         = 'Загрузить модификацию VQMod:';
...
$_['success_clear_log']          = 'Лог ошибок очищен!';
$_['success_delete']             = 'Success: VQMod script deleted!';
$_['success_install']            = 'Модификация VQMod активирована!';
$_['success_uninstall']          = 'Модификация VQMod отключена!';
$_['success_upload']             = 'Модификация VQMod загружена!';
...
// Manual mode
$_['vqmod_manual']               = 'Переключить в ручной режим';
$_['vqmod_manual_adv']           = 'Включите ручной режим для большей производительности';
$_['vqmod_manual_wait']          = 'Создание базы модификаций, это может занять до 30 секунд...';
$_['vqmod_auto']                 = 'Переключить в авторежим';
$_['vqmod_auto_adv']             = 'Авторежим более удобен для разработки и настройки';
$_['vqmod_apply']                = 'Применить изменения';
$_['vqmod_toapply']              = 'Нажмите "Применить изменения" что бы изменения вступили в силу.';

// Hidden
$_['hidden_file']                = 'Скрытый';
$_['show_hidden']                = 'Показать скрытые модификации';
