 ...
 * @version     1.5.1.1 $Id: product_viewed.php 3 2011-08-29 11:09:52Z krzysztof.kardasz $
 * @link        http://opencart-polish.googlecode.com
 * @link        http://opencart-polish.googlecode.com/svn/branches/1.5.x/
 */
// Heading
$_['heading_title']  = 'Raport wyświetleń produktów';

// Text
$_['text_success']   = 'Sukces: Raport został zresetowany!';

// Column
$_['column_name']    = 'Nazwa produktu';
$_['column_model']   = 'Model';
$_['column_viewed']  = 'Wyświetleń';
