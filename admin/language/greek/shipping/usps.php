...
$_['text_success']          = 'Επιτυχία: Επεξεργαστήκατε United States Postal Service!';
...
$_['entry_firstclass']      = 'Domestic First Class Rate Τύπος:<br/><span class="help">First class applies to 13oz packages or less. When disabled, standard premium rates are returned.</span>';
...
// Error
$_['error_permission']      = 'Προσοχή: Δεν έχετε την άδεια να επεξεργαστείτε United States Postal Service!';
