...
$_['text_success']                 = 'Επιτυχία: Επεξεργαστήκατε UPS shipping!';
...
$_['entry_packaging']              = 'Packaging Τύπος:<span class="help">What kind of packaging do you use?</span>';
$_['entry_classification']         = 'Customer Classification Κωδικός:<span class="help">01 - If you are billing to a UPS account and have a daily UPS pickup, 03 - If you do not have a UPS account or you are billing to a UPS account but do not have a daily pickup, 04 - If you are shipping from a retail outlet (only used when origin is US)</span>';
$_['entry_origin']                 = 'Shipping Origin Κωδικός:<span class="help">What origin point should be used (this setting affects only what UPS product names are shown to the user)</span>';
...
$_['entry_postcode']               = 'Origin Zip/Postal Κωδικός:<span class="help">Enter your origin zip/postalcode.</span>';
$_['entry_test']                   = 'Test Mode:<span class="help">Use this module in Test (YES) or Production mode (NO)?</span>';
$_['entry_quote_type']             = 'Quote Τύπος:<span class="help">Quote for Residential or Commercial Delivery.</span>';
...
$_['entry_weight_code']            = 'Weight Κωδικός:<br /><span class="help">Allowed kgs or lbs. Make sure you match the weight class with the UPS accepted weight code.</span>';
$_['entry_weight_class']           = 'Weight Class:<span class="help">Set to kilograms or pounds.</span>';
$_['entry_length_code']            = 'Length Κωδικός:<br /><span class="help">Make sure you match the measurement class with the measurement code.</span>';
...
// Error
$_['error_permission']             = 'Προσοχή: Δεν έχετε την άδεια να επεξεργαστείτε UPS (US) shipping!';
