...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">Original module author: <b>Fido-x</b>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="location = '<?php echo $news; ?>';" class="button"><span><?php echo $button_news; ?></span></a>&nbsp;&nbsp;&nbsp;<a onclick="$('#form').submit();" class="button"><span><b><?php echo $button_save; ?></b></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
