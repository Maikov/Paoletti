...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">Module author: <b>ryuzaki01</b> – <a href="http://shinjikagehisa.web.id">http://shinjikagehisa.web.id</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
				...
				<td class="left"><input type="text" name="facebook_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                <?php if (isset($error_dimension[$module_row])) { ?>
                <span class="error"><?php echo $error_dimension[$module_row]; ?></span>
                <?php } ?></td>
				<td class="left"><input type="text" name="facebook_module[<?php echo $module_row; ?>][numpost]" value="<?php echo $module['numpost']; ?>" size="3" />
...
function addModule() {	
	...
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="facebook_module[' + module_row + '][width]" value="" size="3" /></td>';
	html += '    <td class="left"><input type="text" name="facebook_module[' + module_row + '][numpost]" value="" size="3" /></td>';	
